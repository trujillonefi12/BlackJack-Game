...
public abstract class PCard {
	...
	/**
	 * Returns a string containing both the rank and suit of the card. This text
	 * will
	 * be placed in the middle of the card to identify the card rank and suit. It
	 * may
	 * include a standard character for the rank and a Unicode character for the
	 * suit.
	 */
	public abstract String getText(); // Returns a value such as "\Ku2605"
